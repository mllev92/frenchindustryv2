...
if page == pages[4] :
    ...
    st.write(f"Le salaire est <span style='font-size: 24px;color: green;'>{round(prediction_MLville[0], 2)} €/h</span> soit environ <span style='font-size: 20px;'>{round(prediction_MLville[0]*4.5*35, 2)} €/mois</span>", unsafe_allow_html=True)
